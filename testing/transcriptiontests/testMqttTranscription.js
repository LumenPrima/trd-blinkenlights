...
client.on('connect', () => {
    ...
    // Subscribe to both audio and calls_active topics
    const topics = [
...
client.on('message', async (topic, message) => {
    ...
    try {
        ...
        // Save raw message to file for analysis
        const filename = `mqtt_message_${messageCount}.json`;
        fs.writeFileSync(filename, JSON.stringify(data, null, 2));
        console.log(`Raw message saved to ${filename}`);
